...
<body class="banner-area">
    ...
    <div class="container container-login shadow bg-white rounded">
      

        <div class="row align-middle">
            <div class="col bg-primary-subtle rounded ">
                <div class="container w-75 p-5">
                <h1 class="text-center display-4 link-text mt-2">Login</h1>
                    <form action="logintemplate.php" method=post>
                        ...
                        <div class="row text-center">
                            <div class="col">
                                <input type="submit" name=sub value="Log In" class="btn btn-primary btn-block mb-4 mx-auto w-50 link-text">
                            </div>
                        </div>
            ...
            <div class="col text-center my-auto">
                ...
                <div class="row mb-4">
                    <div class="col d-flex justify-content-center">
                    <a href="Register.php" class ="link-text">Don't Have an Account?</a>
                    </div>
                </div>
