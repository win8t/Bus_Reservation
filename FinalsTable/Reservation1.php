...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="row ">
      <div class="col pb-2 ">
        <h1 class="hd-font bg-row mx-auto text-white rounded-bottom mx-1 p-3">RESERVATION DETAILS | Welcome Admin!</h1>
                ...
                <form action="Reservation1.php" method="post">
                  <div class="modal-body">
                    ...
                    <div class="row form-outline">
                      ...
                      <div class="col">
                        <!-- Seat Number -->
                        <input type="number" id="" name="seat_number" class="form-control" />
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<table class='table table-sm table-striped text-center table-bordered w-100 border border-2 table-responsive border-dark align-middle mx-auto'>";
                ...
                <div class="row form-outline">
                  ...
                  <div class="col">
                        <select name="update_status" id="status" class="form-select">
                          ...
                          <option value="Reserved" <?php if ($fielddata['status'] === 'Reserved') echo 'selected'; ?> >Reserved</option>
                          <option value="Cancelled" <?php if ($fielddata['status'] === 'Cancelled') echo 'selected'; ?> >Cancelled</option>
                          <option value="Boarded" <?php if ($fielddata['status'] === 'Boarded') echo 'selected'; ?> >Boarded</option>
                        </select>
                        <label class="form-label" for="">Status</label>
                      </div>
