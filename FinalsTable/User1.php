  ...
  <div class="container-fluid">
    ...
    <div class="row ">
      <div class="col pb-2 ">
        ...
        <button type="button" id="formDetailsBtn" class="btn hd-text btn-color mx-1" data-bs-toggle="modal" data-bs-target="#formDetails">
...
<?php
    ...
    if (isset($_POST['delete'])) {
      $user_delete = $_POST['user_del']; // Retrieve the user_id from the form
