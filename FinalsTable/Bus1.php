...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="row ">
      <div class="col pb-2 ">
        <h1 class="hd-font bg-row mx-auto text-white rounded-bottom mx-1 p-3">BUS DETAILS | Welcome Admin!</h1>
              ...
              <h5 class="hd-text text-center pb-2 fs-5" id="title">Bus Editing Form</h5>
                    ...
                    <!-- Bus Number input -->
                      ...
                      <select name="update_type" id="bus_type" class="form-select" required>
                          <option value="" selected disabled>Select Bus Type</option>
                          <option value="Executive" <?php if ($fielddata['bus_type'] === 'Executive') echo 'selected'; ?> >Executive</option>
                          <option value="Executive Solo" <?php if ($fielddata['bus_type'] === 'Executive Solo') echo 'selected'; ?>>Executive Solo</option>
                          <option value="Executive Class" <?php if ($fielddata['bus_type'] === 'Executive Class') echo 'selected'; ?>>Executive Class</option>
                          <option value="Executive Luxury" <?php if ($fielddata['bus_type'] === 'Executive Luxury') echo 'selected'; ?>>Executive Luxury</option>
                          <!-- Add more options as needed -->
                        </select>
                        <label class="form-label" for="">Bus Type</label>
                        </div>
